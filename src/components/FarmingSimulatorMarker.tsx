import { createPosition, FarmingSimulatorCollectible, FarmingSimulatorCollectibleColor, FarmingSimulatorCollectibleType } from "@/api/farmingSimulatorCollectibles";
...
interface ElmcreekMarkerProps {
  collectible: FarmingSimulatorCollectible,
}
